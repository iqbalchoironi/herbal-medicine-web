            ...
            flexDirection:"column"
                ...
                <div style={{
                    ...
                    <FormControl className={classes.margin}>
                        ...
                        <InputBase className={classes.input} name="inputSearch" value={this.state.inputSearch} onKeyDown={this.handleKeyDown} onChange={this.handleInputChange} placeholder="Search here..." />
                        <IconButton href={`/search/${ this.state.inputSearch }`} className={classes.iconButton}  aria-label="Search">
                            <SearchIcon />
                        </IconButton>
                    </Paper>
                </div>
