            ...
            <div>
                 <Paper style={{
                    ...
                    <FormControl margin="normal" fullWidth>
                        ...
                        <Input onChange={this.handleChange} id="name" type="password" required/>
                    </FormControl>
                    ...
                    <Button onClick={this.handleSubmit} variant="contained" color="primary" size="medium">Register</Button>
                </Paper>
            </div>
        )
    }
